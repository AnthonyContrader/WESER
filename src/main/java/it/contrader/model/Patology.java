...
public class Patology {
	...
	public Patology(String patology, String carename, String patcf, String quantity, int patominpress, int patomaxpress,
			int patomincir, int patomaxcir, int patominbreath, int patomaxbreath, float patomintemp,
			float patomaxtemp) {
