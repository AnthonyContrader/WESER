...
public class ReadingService {
	...
	public List<ReadingDTO> findReadingDTOById(int id) {
		
		final List<Reading> list = readingRepository.findAllById(id);
	...
	public List<ReadingDTO> findReadingDTOById(String content) {
