<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="it.contrader.dto.EmergencyDTO" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<title>EMERGENCYS UPDATE</title>

<%
	EmergencyDTO emergencyUpdate = (EmergencyDTO) request.getAttribute("emergency");
%>
<meta charset="utf-8">
  ...
  <title>Update Emergency number</title>
   ...
   <%@ include file="/function/menuTutor.jsp" %>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Emergency number Update</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="index.html">Home</a></li>
              <li><i class="fa fa-laptop"></i>Emergency number Update</li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        		<form method="POST" action="/Emergency/updateEmergency">
			<input type="hidden" name="id" value="<%=emergencyUpdate.getId()%>" />
			<table class="table">

			<tr>
				<td><b>Emergency number:</b></td>
				<td> <input type="text" size="40" maxlength="40" name="num" value="<%=emergencyUpdate.getNum()%>" /></td>
			</tr>
