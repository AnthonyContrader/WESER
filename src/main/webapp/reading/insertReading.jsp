 ...
 <%@ include file="/function/menuDoctor.jsp" %>
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i> Insert Reading</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i>Home</a></li>
              <li><i class="fa fa-laptop"></i>Insert Reading</li>
            </ol>
          </div>
        </div>
        ...
        <div class="row">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        		<form class="insert-form" action="/Reading/insertReading" method="post">
		<table>
			<tr>
				<td>Patient ssc</td><td><input type="text" name="patcf" placeholder="Patcf"></td>
			</tr>
			
			<tr>
				<td>Reg device</td><td><input type="text" name="regdev" placeholder="Regdev"></td>
			</tr>
			
			<tr>
				<td>Min press</td><td><input type="number" min="0" max="400" name="minpress" placeholder="Minpress"></td>
			</tr>
			
			<tr>
				<td>Max press</td><td><input type="number" min="0" max="400" name="maxpress" placeholder="Maxpress"></td>
			</tr>
				<tr>
				<td>Min circ</td><td><input type="number" min="0" max="400" name="mincir" placeholder="Mincir"></td>
			</tr>
			
			<tr>
				<td>Max circ</td><td><input type="number" min="0" max="400" name="maxcir" placeholder="Maxcir"></td>
			</tr>
				<tr>
				<td>Min breath</td><td><input type="number" min="0" max="400" name="minbreath" placeholder="Minbreath"></td>
			</tr>
			
			<tr>
				<td>Max breath</td><td><input type="number" min="0" max="400" name="maxbreath" placeholder="Maxbreath"></td>
			</tr>
				<tr>
				<td>Min temp</td><td><input type="number" step="any" min="0" max="45" name="minbreath" placeholder="Minbreath"></td>
			</tr>
	...
	<br>
	<a class="btn btn-primary btn-lg btn-block" href="/Reading/readingManagement">Back</a>
            </div>
        </div>
