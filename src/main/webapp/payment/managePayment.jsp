...
<body>
	...
	<table>
		...
		<tr>
			...
			<td><a href="PaymentServlet?richiesta=updateRedirect&id=<%=payment.getPayId() %>">Update</a></td>
	...
	<br>
	<a href="/JspApp/PaymentServlet?richiesta=insertRedirect"><i class="fas fa-plus-circle fa-lg"> New User</i></a>
	<br>	
