...
public class DeviceServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException {
		...
		case "insert":
			...
			final String regnumber = request.getParameter("regnum");
			...
			final int mincirr = Integer.parseInt(request.getParameter("mincirr"));
			final int maxcirr = Integer.parseInt(request.getParameter("maxcirr"));
		...
		case "update":
			...
			final String regnumberUpdate = request.getParameter("regnum");
			...
			final int mincirrUpdate = Integer.parseInt(request.getParameter("mincirr"));
			final int maxcirrUpdate = Integer.parseInt(request.getParameter("maxcirr"));
			...
			final DeviceDTO device = new DeviceDTO(regnumberUpdate,devtypeUpdate, descriptionUpdate, minpressUpdate,maxpressUpdate,mincirrUpdate,maxpressUpdate,minbreathUpdate,maxbreathUpdate,mintempUpdate,maxtempUpdate);
