...
CREATE TABLE `emergency` (
  ...
  `em_num` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id_em`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Insert emergency number';
/*!40101 SET character_set_client = @saved_cs_client */;
